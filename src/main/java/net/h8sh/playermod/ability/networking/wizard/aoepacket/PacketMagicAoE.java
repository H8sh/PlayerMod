package net.h8sh.playermod.ability.networking.wizard.aoepacket;
...
public class PacketMagicAoE {

    public PacketMagicAoE() {

    }

    public PacketMagicAoE(FriendlyByteBuf buf) {
