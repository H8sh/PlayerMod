    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
      /*  ItemStack itemstack = pPlayer.getItemInHand(pHand);
        ...
        if (!pLevel.isClientSide) {
            Sniper sniper = new Sniper(pLevel, pPlayer);
            sniper.setItem(itemstack);
            sniper.shootFromRotation(pPlayer, pPlayer.getXRot(), pPlayer.getYRot(), 0.0F, 1.5F, 1.0F);
            pLevel.addFreshEntity(sniper);
        }
