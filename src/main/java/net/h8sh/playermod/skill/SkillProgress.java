...
public class SkillProgress implements Comparable<SkillProgress> {
    ...
    private SkillProgress(Map<String, CriterionProgress> pCriteria) {
    ...
    public int compareTo(SkillProgress p_8195_) {
    ...
    public static class Serializer implements JsonDeserializer<SkillProgress>, JsonSerializer<SkillProgress> {
        ...
        public SkillProgress deserialize(JsonElement pJson, Type pTypeOfT, JsonDeserializationContext pContext) throws JsonParseException {
