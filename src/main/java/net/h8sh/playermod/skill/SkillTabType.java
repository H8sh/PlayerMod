...
enum SkillTabType {
    ...
    private SkillTabType(int pTextureX, int pTextureY, int pWidth, int pHeight, int pMax) {
    ...
    public void draw(GuiGraphics pGuiGraphics, int pOffsetX, int pOffsetY, boolean pIsSelected, int pIndex) {
        ...
        pGuiGraphics.blit(SkillScreen.TABS_LOCATION, pOffsetX + this.getX(pIndex), pOffsetY + this.getY(pIndex), i, j, this.width, this.height);
    }
