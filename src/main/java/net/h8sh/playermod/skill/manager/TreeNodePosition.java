...
public class TreeNodePosition {
    ...
    public TreeNodePosition(Skill pAdvancement, @Nullable TreeNodePosition pParent, @Nullable TreeNodePosition pPreviousSibling, int pChildIndex, int pX) {
    ...
    @Nullable
    private TreeNodePosition addChild(Skill pAdvancement, @Nullable TreeNodePosition pPrevious) {
        if (pAdvancement.getDisplay() != null) {
    ...
    public static void run(Skill pRoot) {
