...
public class CustomCriteriaTriggers {
    private static final Map<ResourceLocation, CustomCriterionTrigger<?>> CRITERIA = Maps.newHashMap();
/*    public static final ImpossibleTrigger IMPOSSIBLE = register(new ImpossibleTrigger());
    ...
    public static <T extends CustomCriterionTrigger<?>> T register(T pCriterion) {
    ...
    @Nullable
    public static <T extends CriterionTriggerInstance> CustomCriterionTrigger<T> getCriterion(ResourceLocation pId) {
        return (CustomCriterionTrigger<T>)CRITERIA.get(pId);
    }

    public static Iterable<? extends CustomCriterionTrigger<?>> all() {
