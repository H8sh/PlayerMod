...
public class SkillRewards {
    public static final SkillRewards EMPTY = new SkillRewards(0, new ResourceLocation[0], new ResourceLocation[0], CommandFunction.CacheableFunction.NONE);
    private final int experience;
    private final ResourceLocation[] loot;
    private final ResourceLocation[] recipes;
    private final CommandFunction.CacheableFunction function;

    public SkillRewards(int pExperience, ResourceLocation[] pLoot, ResourceLocation[] pRecipes, CommandFunction.CacheableFunction pFunction) {
    ...
    public static SkillRewards deserialize(JsonObject pJson) throws JsonParseException {
        ...
        return new SkillRewards(i, aresourcelocation, aresourcelocation1, commandfunction$cacheablefunction);
    }
    ...
    public static class Builder {
        ...
        public SkillRewards build() {
            return new SkillRewards(this.experience, this.loot.toArray(new ResourceLocation[0]), this.recipes.toArray(new ResourceLocation[0]), this.function == null ? CommandFunction.CacheableFunction.NONE : new CommandFunction.CacheableFunction(this.function));
        }
    }
}
