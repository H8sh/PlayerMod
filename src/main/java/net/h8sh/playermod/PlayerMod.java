...
import net.h8sh.playermod.entity.client.pet.PetRenderer;
import net.h8sh.playermod.entity.client.pet.SwouiffiRenderer;
import net.h8sh.playermod.entity.client.pnj.PnjEntityRenderer;
import net.h8sh.playermod.entity.client.wizard.CrystalRenderer;
import net.h8sh.playermod.entity.client.wonderlandshome.LivingLamppostRenderer;
