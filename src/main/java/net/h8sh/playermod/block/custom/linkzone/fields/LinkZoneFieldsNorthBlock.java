package net.h8sh.playermod.block.custom.linkzone.fields;

import net.h8sh.playermod.networking.ModMessages;
import net.h8sh.playermod.networking.travelling.OnChangedDimensionToCitadelC2SPacket;
import net.h8sh.playermod.networking.travelling.OnChangedDimensionToFieldsC2SPacket;
...
public class LinkZoneFieldsNorthBlock extends Block {
    private static final VoxelShape VOXEL_SHAPE = Shapes.box(0, 0, 0, 1, 1, 1);

    public LinkZoneFieldsNorthBlock(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        if (entity instanceof Player player) {
            ...
            ModMessages.sendToServer(new OnChangedDimensionToFieldsC2SPacket());
        }
    }
